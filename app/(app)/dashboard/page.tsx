      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-3 gap-4 mb-8">
          <div className="bg-[#1a1a1a] rounded-xl border border-white/5 p-4">
            <p className="text-xs text-white/30 uppercase tracking-wide mb-1">Open tasks</p>
          ...
          <div className="bg-[#1a1a1a] rounded-xl border border-white/5 p-4">
            <p className="text-xs text-white/30 uppercase tracking-wide mb-1">Due soon</p>
            <p className={`text-2xl font-semibold ${dueSoonTasks.length > 0 ? 'text-yellow-400' : 'text-white'}`}>
              {dueSoonTasks.length}
            </p>
          </div>
        </div>
