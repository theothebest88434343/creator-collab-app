  ...
  return (
    <div className="min-h-screen bg-[#0f0f0f] text-white">
      ...
      <section className="max-w-4xl mx-auto px-8 pt-24 pb-20 text-center">
        <div className="scroll-animate inline-block bg-white/5 border border-white/10 rounded-full px-4 py-1.5 text-xs text-white/50 mb-8">
          ✨ AI-powered project management for creators
        </div>
        <h1 className="scroll-animate scroll-animate-delay-1 text-5xl sm:text-6xl font-semibold tracking-tight mb-6" style={{ lineHeight: '1.15' }}>
          Stop guessing.<br />
          <span className="text-white/40">Start creating.</span>
        </h1>
        <p className="scroll-animate scroll-animate-delay-2 text-lg text-white/40 max-w-xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="scroll-animate scroll-animate-delay-3 flex items-center justify-center gap-4">
      ...
      <section className="max-w-5xl mx-auto px-8 py-20 border-t border-white/5">
        ...
        <p className="scroll-animate scroll-animate-delay-1 text-white/40 text-center text-sm mb-16 max-w-xl mx-auto">Built specifically for content creators, YouTubers, podcasters, and small creative teams.</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            <div
              key={feature.title}
              className={`scroll-animate scroll-animate-delay-${i % 3 + 1} bg-[#1a1a1a] rounded-2xl border border-white/5 p-6 hover:border-white/10 transition-colors`}
            >
      ...
      <section className="max-w-4xl mx-auto px-8 py-20 border-t border-white/5">
        <div className="scroll-animate bg-[#1a1a1a] rounded-2xl border border-white/10 p-10 text-center">
      ...
      {/* How it works */}
      <section className="max-w-4xl mx-auto px-8 py-20 border-t border-white/5">
        <h2 className="scroll-animate text-2xl font-semibold text-center mb-16">Get started in 3 steps</h2>
      ...
      <section className="max-w-2xl mx-auto px-8 py-20 text-center border-t border-white/5">
        <h2 className="scroll-animate text-3xl font-semibold mb-4">Ready to get organized?</h2>
        <p className="scroll-animate scroll-animate-delay-1 text-white/40 mb-8">Join creators already using Collab to manage their projects smarter.</p>
